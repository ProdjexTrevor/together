...
export function createSeedState() {
  ...
  const notifications: Notification[] = [
    ...
    },
    {
      ...
      body: "Shonda assigned Book dentist appointments to you.",
      read_at: iso(0),
      created_at: iso(-2),
    },
  ];
